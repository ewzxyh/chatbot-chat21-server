...
app.post('/:app_id/requests', (req, res) => {
  console.log('requests');
    ...
    //curl 'https://us-central1-chat-v2-dev.cloudfunctions.region(config.region).net/supportapi/tilechat/requests/create?token=[REDACTED_TOKEN],&sender_fullname=Bash&text=pingfromAPI&projectid=5b45e1c75313c50014b3abc6'
