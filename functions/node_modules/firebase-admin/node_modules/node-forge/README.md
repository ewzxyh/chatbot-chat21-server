...
var privateKey = REDACTED_SECRET(pem);

// convert a Forge private key to PEM-format
var pem = pki.privateKeyToPem(privateKey);

// convert an ASN.1 PrivateKeyInfo or RSAPrivateKey to a Forge private key
var privateKey = REDACTED_SECRET(rsaPrivateKey);

// convert a Forge private key to an ASN.1 RSAPrivateKey
var rsaPrivateKey = REDACTED_SECRET(privateKey);
...
var privateKey = REDACTED_SECRET(pem, 'password');
...
* For [PayPal][] please send to redacted@example.invalid.
* Something else? Please contact redacted@example.invalid.
