...
describe('string', function () {
    ...
    describe('#validate', function () {
        ...
        it('validates combination of email, min, max, and invalid', function (done) {
            ...
            var rule = Joi.string().email().min(8).max(10).invalid('redacted@example.invalid');
            Helper.validate(rule, [
                ['redacted@example.invalid', false],
                ['redacted@example.invalid', false],
                ['redacted@example.invalid', true],
        ...
        it('validates combination of email, min, max, and allow', function (done) {
            ...
            var rule = Joi.string().email().min(8).max(10).allow('redacted@example.invalid');
            Helper.validate(rule, [
                ['redacted@example.invalid', true],
                ['redacted@example.invalid', true],
                ['redacted@example.invalid', true],
        ...
        it('validates combination of email, min, max, allow, and invalid', function (done) {
            ...
            var rule = Joi.string().email().min(8).max(10).allow('redacted@example.invalid').invalid('redacted@example.invalid');
            Helper.validate(rule, [
                ['redacted@example.invalid', true],
                ['redacted@example.invalid', false],
                ['redacted@example.invalid', true],
        ...
        it('validates combination of email, min, max, allow, invalid, and allow(\'\')', function (done) {
            ...
            var rule = Joi.string().email().min(8).max(10).allow('redacted@example.invalid').invalid('redacted@example.invalid').allow('');
            Helper.validate(rule, [
                ['redacted@example.invalid', true],
                ['redacted@example.invalid', false],
                ['redacted@example.invalid', true],
        ...
        it('validates combination of email, min, max, allow, and allow(\'\')', function (done) {
            ...
            var rule = Joi.string().email().min(8).max(10).allow('redacted@example.invalid').allow('');
            Helper.validate(rule, [
                ['redacted@example.invalid', true],
                ['redacted@example.invalid', true],
                ['redacted@example.invalid', true],
        ...
        it('validates combination of email, min, max, allow, invalid, and regex', function (done) {
            ...
            var rule = Joi.string().email().min(8).max(10).allow('redacted@example.invalid').invalid('redacted@example.invalid').regex(/^1/);
            Helper.validate(rule, [
                ['redacted@example.invalid', true],
                ['redacted@example.invalid', false],
                ['redacted@example.invalid', true],
        ...
        it('validates combination of email, min, max, allow, invalid, regex, and allow(\'\')', function (done) {
            ...
            var rule = Joi.string().email().min(8).max(10).allow('redacted@example.invalid').invalid('redacted@example.invalid').regex(/^1/).allow('');
            Helper.validate(rule, [
                ['redacted@example.invalid', true],
                ['redacted@example.invalid', false],
                ['redacted@example.invalid', true],
        ...
        it('validates uri', function (done) {
            ...
            Helper.validate(schema, [
                ...
                ['mailto:redacted@example.invalid', true],
                ...
                ['xmpp:redacted@example.invalid', true],
                ...
                ['[REDACTED_BASIC_AUTH_URL]', true],
                ['[REDACTED_BASIC_AUTH_URL]', true],
                ['http://redacted@example.invalid/', true],
                ['http://redacted@example.invalid/', true],
                ...
                ['//username:redacted@example.invalid/one/two/three?value=abc&value2=123#david-rules', false],
                ['http://a\r" \t\n<\'b:b@c\r\nd/e?f', false]
            ], done);
        });
