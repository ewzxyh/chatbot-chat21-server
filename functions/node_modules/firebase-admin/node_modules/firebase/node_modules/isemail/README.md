...
undefined
> isEmail('redacted@example.invalid');
true
> isEmail('redacted@example.invalid', log);
result true
true
> isEmail('redacted@example.invalid', {checkDNS: true});
undefined
> isEmail('redacted@example.invalid', {checkDNS: true}, log);
undefined
result true
> isEmail('redacted@example.invalid', {errorLevel: true});
0
> isEmail('redacted@example.invalid', {errorLevel: true}, log);
result 0
0
> isEmail('redacted@example.invalid');
true
> isEmail('redacted@example.invalid', {checkDNS: true, errorLevel: true}, log);
undefined
result 6
> isEmail('redacted@example.invalid', {checkDNS: true, errorLevel: 7}, log);
undefined
result 0
> isEmail('redacted@example.invalid', {checkDNS: true, errorLevel: 6}, log);
undefined
result 6
```
