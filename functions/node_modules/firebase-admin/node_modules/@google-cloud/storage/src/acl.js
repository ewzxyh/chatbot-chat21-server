 ...
 * Examples:
 *
 *   - The user "redacted@example.invalid" would be `redacted@example.invalid`.
 *   - The group "redacted@example.invalid" would be
 ...
 * var myFile = myBucket.file('my-file');
 * myFile.acl.owners.addUser('redacted@example.invalid', function(err, aclObject) {});
 *
 * //-
 * // For reference, the above command is the same as running the following.
 * //-
 * myFile.acl.add({
 *   entity: 'redacted@example.invalid',
 ...
 * //-
 * myFile.acl.owners.addUser('redacted@example.invalid').then(function(data) {
 ...
 * //-
 * myFile.acl.readers.addUser('redacted@example.invalid', function(err, aclObject) {});
 *
 * //-
 * // For reference, the above command is the same as running the following.
 * //-
 ...
 * // If the callback is omitted, we'll return a Promise.
 * //-
 * myFile.acl.readers.addUser('redacted@example.invalid').then(function(data) {
 *   var aclObject = data[0];
 *   var apiResponse = data[1];
 * });
 */
 ...
 * //-
 * myFile.acl.writers.addUser('redacted@example.invalid', function(err, aclObject) {});
 *
 * //-
 * // For reference, the above command is the same as running the following.
 * //-
 ...
 * // If the callback is omitted, we'll return a Promise.
 * //-
 * myFile.acl.writers.addUser('redacted@example.invalid').then(function(data) {
 *   var aclObject = data[0];
 *   var apiResponse = data[1];
 * });
 */
 ...
 *
 *   myBucket.acl.owners.addUser('redacted@example.invalid', function(err, acl) {});
 *
...
AclRoleAccessorMethods.entities = [
  ...
  // Entity groups that require specification, e.g. `redacted@example.invalid`.
  'domain-',
  'group-',
  'project-',
  'user-',
