...
```bash
git clone redacted@example.invalid:chat21/chat21-cloud-functions.git
cd functions
npm install
```
...
- Click on "Add New User" and populate Email and Password field with for example : email = redacted@example.invalid, password = 123456
