...
```
   curl -X POST \
       -H 'Content-Type: application/json' \
       -d '{"sender_fullname": "Andrea Leo", "request_id": "redacted@example.invalid-Re: subject", "recipient_fullname":"Andrea Leo","text":"hello from API","projectid":"5ab0f32757066e0014bfd718"}' \
